...
class EAST_Net(nn.Module):      # HMIN Encoder-Decoder Framework w/ MDFG
    ...
    def forward(self, x_seq: Tensor, t_x: Tensor, t_y: Tensor, ht_pair:tuple = None, G: tuple = None):
        '''
        ...
        # if ht_pair is None:
        #     ht_pair = (torch.zeros(batch_size, n_node, self.h_dim),
        #        torch.zeros(batch_size, c_in, self.h_dim))
